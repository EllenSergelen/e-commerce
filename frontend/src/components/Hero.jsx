      ...
      <div className='w-full sm:w-1/2 flex items-center justify-center py-10 sm:py-0 bg-violet-700 rounded-l-3xl'>
        <div className='text-[#414141]'>
          <div className='flex items-center gap-2'>
            ...
            <p className='font-medium text-sm md:text-base text-white'>БИДНИЙ БЕСТЕЛЛЕРҮҮД</p>
          </div>
          <h1 className='prata-regular text-3xl sm:py-3 lg:text-5xl leading-relaxed text-white'>Шинээр ирсэн бүтээгдэхүүн</h1>
          <div className='flex items-center gap-2'>
            <p className='font-semibold text-sm md-text-base text-white'>ХУДАЛДАН АВАХ</p>
