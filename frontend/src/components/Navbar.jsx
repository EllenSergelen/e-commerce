...
const Navbar = () => {
  ...
  const logout = () => {
    navigate('/login') // Added leading slash for consistent routing
    ...
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <div className='flex items-center gap-6'>
        ...
        <Link to='/cart' className='relative'>
          ...
          <p className='absolute right-[-5px] top-[-5px] w-4 leading-4 text-center bg-black text-white aspect-square rounded-full text-[8px]'>{getCartCount()}</p>
        </Link>
